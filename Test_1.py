...
class Missile:
    ...
    def trouver_alpha_optimal(self):
        ...
        for alpha_deg in np.arange(alpha_min, alpha_max, 1):  # Pas réduit pour accélérer les tests
        ...
        # Pour plus de précision, on peut affiner autour de l'angle trouvé
        for alpha_deg in np.arange(alpha_optimal - 1, alpha_optimal + 1, 0.1):
            # Réinitialiser la liste des altitudes
            self.altitudes = [self.altitude]
        ...
        # Restaurer l'angle d'attaque original
